...
function TimeMenu() {
    ...
    return (
        <div className="RHYME-menu-root" onMouseEnter={e => handleClick(e)} onMouseLeave={e => handleClick(e)}>
            <div className="RHYME-menu-btn">
                <p>RHYME</p>
            </div>

            <Popper className="RHYME-menu-popper" open={open} anchorEl={anchorEl} transition>
                {({ TransitionProps }) => (
                        ...
                        <div className="tooltip">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("RHYME", TIME_ADDRESS)}>
                                        <p>RHYME</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("REMO", MEMO_ADDRESS)}>
                                        <p>REMO</p>
                                    </div>
                                </div>
                            )}
